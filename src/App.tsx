      ...
      >
        <section style={{ marginTop: xs ? "1.75rem" : "2.5rem" }}>
          ...
          <div style={{ marginTop: xs ? "1rem" : "1.5rem" }}>
            <RuleDetails title="Подготовка и цель игры">
              <ul style={{ paddingLeft: "1.25rem", margin: 0 }}>
                <li style={{ marginTop: 0 }}>
                  <strong>Игроки:</strong> Четыре игрока, образующие две команды
                  по два партнёра. Партнёры сидят друг напротив друга.
                </li>
                <p></p>
                <li style={{ marginTop: 0 }}>
                  <strong>Оборудование:</strong> Игровое поле Jackaroo, 16
                  шариков 4 цветов и стандартная колода из 52 карт. На поле есть
                  зоны: Дом, База, Общий трек и Личная безопасная зона.
                </li>
                <p></p>

                <li style={{ marginTop: 0 }}>
                  <strong>Цель:</strong> Первая команда, которая приведёт все
                  восемь своих шариков в «зону безопасности», выигрывает. Когда
                  все шарики одного игрока уже находятся в своей безопасной зоне
                  то после этого он ходит шариками своего напарника.
                </li>
              </ul>
            </RuleDetails>

            <RuleDetails title="Игровой процесс">
              <ul style={{ paddingLeft: "1.25rem", margin: 0 }}>
                <li style={{ marginBottom: "0.25rem" }}>
                  <strong>Раздача:</strong> Ведущий (дилер) тасует карты и
                  раздаёт каждому игроку по четыре карты. Игра продолжается по
                  часовой стрелке, начиная с игрока слева от дилера.
                </li>
                <p></p>

                <li style={{ marginBottom: "0.25rem" }}>
                  <strong>Ходы:</strong> В свой ход игрок разыгрывает одну карту
                  и передвигает один из своих шариков в соответствии со
                  значением карты или её особым действием. Если игрок не может
                  разыграть карту, он должен сбросить её и пропустить ход.
                </li>
                <p></p>

                <li style={{ marginBottom: "0.25rem" }}>
                  <strong>Передвижение:</strong> Шарики начинают движение из
                  базы и двигаются по основному треку.
                </li>
                <p></p>

                <li>
                  <strong>Съедание противника:</strong> Если шарик игрока
                  попадает на клетку, где стоит шарик соперника, тот «съедается»
                  и возвращается в свой дом.
                </li>
                <p></p>

                <li>
                  <strong>Безопасность:</strong> Шарик, находящийся в базе,
                  нельзя сдвинуть, обойти или «съесть». Если два собственных
                  шарика стоят подряд, передний считается «базой» — его нельзя
                  перепрыгнуть или съесть.
                </li>
              </ul>
            </RuleDetails>
