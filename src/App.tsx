            ...
            <RuleDetails title="Подготовка и цель игры">
              <ul style={{ paddingLeft: "1.25rem", margin: 0 }}>
                <li style={{ marginTop: 0 }}>
                  Игроки: Четыре игрока, образующие две команды по два партнёра.
                  Партнёры сидят друг напротив друга.
                </li>
                <li style={{ marginTop: 0 }}>
                  Оборудование: Игровое поле Jackaroo, 16 шариков 4 цветов и
                  стандартная колода из 52 карт. На поле есть зоны: Дом, База,
                  Общий трек и Личная безопасная зона.
                </li>
                <li style={{ marginTop: 0 }}>
                  Цель: Первая команда, которая приведёт все восемь своих
                  шариков в «зону безопасности», выигрывает. Когда все шарики
                  одного игрока уже находятся в своей безопасной зоне то после
                  этого он ходит шариками своего напарника.
                </li>
              </ul>
            </RuleDetails>
            ...
            <RuleDetails title="Игровой процесс">
              <ul style={{ paddingLeft: "1.25rem", margin: 0 }}>
                <li style={{ marginBottom: "0.25rem" }}>
                  Раздача: Ведущий (дилер) тасует карты и раздаёт каждому игроку
                  по четыре карты. Игра продолжается по часовой стрелке, начиная
                  с игрока слева от дилера.
                </li>
                <li style={{ marginBottom: "0.25rem" }}>
                  Ходы: В свой ход игрок разыгрывает одну карту и передвигает
                  один из своих шариков в соответствии со значением карты или её
                  особым действием. Если игрок не может разыграть карту, он
                  должен сбросить её и пропустить ход.
                </li>
                <li style={{ marginBottom: "0.25rem" }}>
                  Передвижение: Шарики начинают движение из базы и двигаются по
                  основному треку.
                </li>
                <li>
                  Съедание противника: Если шарик игрока попадает на клетку, где
                  стоит шарик соперника, тот «съедается» и возвращается в свой
                  дом.
                </li>
                <li>
                  Безопасность: Шарик, находящийся в базе, нельзя сдвинуть,
                  обойти или «съесть». Если два собственных шарика стоят подряд,
                  передний считается «базой» — его нельзя перепрыгнуть или
                  съесть.
                </li>
              </ul>
            </RuleDetails>
